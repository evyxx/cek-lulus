...
<head>
    ...
    <meta name="description" content="Sistem Informasi Kelulusan {{$web->web_name }}">
    <meta name="keywords" content="Sistem Informasi Kelulusan {{$web->web_name }}">
    <meta name="author" content="IT Code">
